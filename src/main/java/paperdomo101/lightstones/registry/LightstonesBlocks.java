...
public class LightstonesBlocks {
    ...
    public static final Block DEEPSLATE_LIGHTSTONE_ORE = new Block(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_COAL_ORE).materialColor(MapColor.GOLD).strength(4.5f, 3f).luminance(7));
    ...
    public static final Block DEEPSLATE_DEATHSTONE_ORE = new Block(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_COAL_ORE).materialColor(DyeColor.RED).strength(4.5f, 3f).luminance(7));
